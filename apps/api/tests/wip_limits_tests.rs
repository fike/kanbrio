...
async fn test_wip_limit_enforcement(pool: sqlx::PgPool) -> anyhow::Result<()> {
    ...
    let card1 = Card::create(&pool, CreateCard {
        parent_id: None,
        workspace_id,
    ...
    let card2 = Card::create(&pool, CreateCard {
        parent_id: None,
        workspace_id,
    ...
    let move_result = Card::move_to(&pool, MoveCard {
        card_id: card2.id,
        workspace_id,
    ...
    let move_result_success = Card::move_to(&pool, MoveCard {
        card_id: card2.id,
        workspace_id,
        to_column_id: col_limit_id,
        to_swimlane_id: lane_id,
    ...
    let create_result = Card::create(&pool, CreateCard {
        parent_id: None,
        workspace_id,
