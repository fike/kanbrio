...
2. **Context Files**: Keeping [`docs/product/discovery.md`](../product/discovery.md), [`docs/product/roadmap.md`](../product/roadmap.md), and [`docs/product/benchmark.md`](../product/benchmark.md) updated so any agent knows exactly what to do next.
