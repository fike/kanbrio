...
1. Reference historical data requirements (Event Sourcing Lite).
2. Explain the statistical distribution used (usually Log-normal for Cycle Time).
3. Validate that WIP limits are correctly enforced in the logic.

Always prioritize flow stability over individual resource utilization.
